...
<table width='80%' border='0'>
    ...
    try{
        ...
        while(resultat.next()){
            ...
            out.println("<td>" + resultat.getString("chemin_photo_prod") + "</td>");
            out.println("<td>" + resultat.getString("isdeleted_prod") + "</td>");
			...
			out.println("<td>" + resultat.getString("produits") + "</td>");
			out.println("</tr>");
		}
